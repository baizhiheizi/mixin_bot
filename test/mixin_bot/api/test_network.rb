...
module MixinBot
  class TestNetwork < Minitest::Test
    ...
    def test_network_ticker_with_default_offset
      ...
      assert_requested(:get, 'https://api.mixin.one/network/ticker',
                      query: { 'asset' => CNB_ASSET_ID })
    end
    ...
    def test_network_ticker_omits_offset_when_nil
      ...
      assert_not_requested(:get, 'https://api.mixin.one/network/ticker',
                           query: { 'offset' => '2024-01-01T00:00:00Z' })
      assert_requested(:get, 'https://api.mixin.one/network/ticker',
                      query: { 'asset' => CNB_ASSET_ID })
    end
